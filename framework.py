...
def write_html(path, index):
  ...
  function menuIconClicked() {
    ...
    menu = """<div class="topnav">
      <a href="http://openmathbooks.netlify.app/mathweb/index.html" class="menu-button">Home</a>
      <a href="http://openmathbooks.netlify.app/mathweb/books/books.html" class="menu-button">Bøker</a>
      <a href="http://openmathbooks.netlify.app/mathweb/corruculum/corruculum.html" class="menu-button">Pensum</a>
      <a href="http://openmathbooks.netlify.app/mathweb/exams/exams.html" class="menu-button">Eksamener</a>
      <a href="http://openmathbooks.netlify.app/mathweb/projects/projects.html" class="menu-button">Ressursbank</a>
